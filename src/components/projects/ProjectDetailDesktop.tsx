...
export function ProjectDetailDesktop(props: ProjectDetailViewProps) {
  ...
  return (
    <>
      {/* ヘッダー */}
      <div className={`relative flex items-center ${compact ? "gap-1.5 flex-wrap pt-3" : embedded ? "gap-2 flex-wrap pt-4" : "gap-4"}`}>
        <span className="absolute top-2 left-2 z-20 px-1.5 py-0.5 rounded bg-red-500 text-white text-[10px] font-black leading-none">PD-1</span>
        {embedded ? (
      ...
      {/* 現場情報カード */}
      {compact ? (
        <div className="relative rounded-lg border border-slate-200 bg-slate-50/50 px-3 py-2.5 space-y-1.5">
          <span className="absolute top-2 left-2 z-20 px-1.5 py-0.5 rounded bg-red-500 text-white text-[10px] font-black leading-none">PD-2</span>
          <div className="flex items-center justify-between">
            <span className="ml-7 text-sm font-semibold text-slate-600 uppercase tracking-wide">現場情報</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="relative">
          ...
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <CardTitle className="ml-7 text-sm font-medium text-slate-500">基本情報</CardTitle>
              <button
        ...
        <Card className="relative">
          <span className="absolute top-2 left-2 z-20 px-1.5 py-0.5 rounded bg-red-500 text-white text-[10px] font-black leading-none">PD-3</span>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <CardTitle className="ml-7 text-sm font-medium text-slate-500">先方担当者</CardTitle>
              <button
      ...
      {compact ? (
        <div className="relative space-y-2">
          <span className="absolute top-2 left-2 z-20 px-1.5 py-0.5 rounded bg-red-500 text-white text-[10px] font-black leading-none">PD-4</span>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <FileText className="ml-7 w-3.5 h-3.5 text-slate-400" />
      ...
      <Card className="relative">
        ...
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 flex-wrap">
            <FileText className="ml-7 w-5 h-5" />
            見積一覧
      ...
      {estimateBundles.length > 0 && (
        <Card className="relative">
          <span className="absolute top-2 left-2 z-20 px-1.5 py-0.5 rounded bg-red-500 text-white text-[10px] font-black leading-none">PD-5</span>
          <CardHeader className="pb-2">
            <CardTitle className="text-base flex items-center gap-2">
              <ClipboardList className="ml-7 w-4 h-4" />
              提出履歴
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
