                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isWknd && !isToday && !isExpanded && "bg-slate-50"
                    )}
                    style={{
                  ...
                  >
                    <div className="flex items-center justify-center gap-0.5">
                      ...
                      <span className="text-[10px] text-slate-400">{format(day, "M/d")}</span>
                    </div>
                    <div
                      className={cn(
                        "text-xs font-medium",
                                    ...
                                    {dayAssignments
                                      ...
                                      .map((a) => (
                                        <div
                                          ...
                                          title={`${a.schedule.contract.project.name} - ${a.worker?.name ?? "未割当"}`}
                                        >
                                          {(
