...
import { Users, Building2, ChevronLeft, ChevronRight, CalendarDays } from "lucide-react"
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-slate-700 min-w-[220px] text-center">
            {rangeLabel}
          </span>
