/**
 * [PAGE] 商談一覧 v2 - シンプル・大文字版
 */
import { createClient } from "@/lib/supabase/server"
import { prisma } from "@/lib/prisma"
import { redirect } from "next/navigation"
import { ProjectListV2 } from "@/components/projects/ProjectListV2"
...
export default async function DashboardV2Page() {
  ...
  return <ProjectListV2 projects={serialized} currentUser={dbUser} templates={templates} />
}
