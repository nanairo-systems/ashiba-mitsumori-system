/**
 * [API] 工期スケジュール更新・削除 - PATCH/DELETE /api/contracts/:id/schedules/:scheduleId
 */
...
export async function PATCH(
  ...
  const schedule = await prisma.constructionSchedule.findUnique({ where: { id: scheduleId } })
  ...
  const updated = await prisma.constructionSchedule.update({
    where: { id: scheduleId },
    data: updateData,
  })
...
export async function DELETE(
  ...
  await prisma.constructionSchedule.delete({ where: { id: scheduleId } })
